...
kubectl config set-credentials demo_user --client-key=${AUTH_DIR}/user-key.pem --client-certificate=${AUTH_DIR}/user.crt --embed-certs=true 
kubectl config set-context minikube_demo_user --user demo_user --cluster minikube 
kubectl config use-context minikube_demo_user 